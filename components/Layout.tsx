  ...
  return (
    <div className="flex flex-col min-h-screen font-body bg-cream text-dark overflow-x-hidden">
      ...
      >
        ...
        <div
          className={`absolute right-0 bottom-0 sm:top-0 w-full sm:max-w-md bg-cream shadow-2xl flex flex-col transition-transform duration-300 max-h-[85vh] sm:max-h-none ${
        ...
        >
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-cream">
            ...
            <button
              onClick={closeCart}
              className="flex items-center justify-center w-9 h-9 rounded-full bg-blush-light hover:bg-wine hover:text-cream text-dark transition-all duration-200 group"
